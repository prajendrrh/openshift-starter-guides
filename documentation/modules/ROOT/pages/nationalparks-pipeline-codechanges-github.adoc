...
----
oc create -f +https://raw.githubusercontent.com/atarazana/nationalparks-java/master/pipeline/nationalparks-triggers.yaml+ -n %PROJECT%
----
--
.NET::
+
...
[source,bash,subs="+attributes,macros+"]
----
oc create -f +https://raw.githubusercontent.com/atarazana/nationalparks-dotnet/master/Pipelines/nationalparks-triggers-all.yaml+ -n %PROJECT%
----
--
Javascript::
+
...
[source,bash,subs="+attributes,macros+"]
----
oc create -f +https://raw.githubusercontent.com/atarazana/nationalparks-js/master/pipelines/nationalparks-triggers-all.yaml+ -n %PROJECT%
----
--
Python::
+
...
[source,bash,subs="+attributes,macros+"]
----
oc create -f +https://raw.githubusercontent.com/atarazana/nationalparks-py/master/pipelines/nationalparks-triggers-all.yaml+ -n %PROJECT%
----
--
====
...
// Go to link:https://github.com/atarazana/nationalparks[Nationalparks,window='_blank'] repository. From top-right side, click to *Fork* to start forking it into your account.

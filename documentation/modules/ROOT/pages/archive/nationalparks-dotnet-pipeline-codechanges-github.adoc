...
----
oc create -f +https://raw.githubusercontent.com/atarazana/nationalparks-java/master/pipeline/nationalparks-triggers-all.yaml+ -n %PROJECT%
----
...
Go to link:https://github.com/atarazana/nationalparks-java[Nationalparks,window='_blank'] repository. From top-right side, click to *Fork* to start forking it into your account.
